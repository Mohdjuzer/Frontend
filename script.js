...
window.addEventListener("scroll",()=>{
    ...
    message.style.left = (value * 1.5 + 350) + "px"; // 50px ahead of the train
    message.style.position = "absolute"; // Make sure it's absolutely positioned
...
let calcScrollValue = ()=>{
 ...
 scrollProgress.style.background = `-webkit-conic-gradient(#194eb9 ${scrollValue}%, #67ccff ${scrollValue}%)`;
